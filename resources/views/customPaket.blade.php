        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="text-center mb-12">
                ...
                <p class="text-gray-500 text-base md:text-lg max-w-xl mx-auto leading-relaxed">
                    Tidak menemukan paket yang sesuai? Ceritakan perjalanan impianmu dan tim kami akan merancangnya khusus
                    untuk Anda.
                </p>
            </div>

            {{-- Form Card --}}
            <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 md:p-10" x-data="customPackageForm()">
                        ...
                        <div class="flex items-center gap-2">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="hidden md:block text-xs font-semibold transition-colors duration-300"
                                    :class="currentStep === i + 1 ? 'text-gray-900' : 'text-gray-400'" x-text="label">
                                </span>
                            </div>
                ...
                <div x-show="currentStep === 1" x-transition:enter="transition ease-out duration-300"
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-red-400 mt-1" x-show="errors.destination" x-text="errors.destination">
                            </p>
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="date" x-model="form.departureDate" :min="today"
                                    class="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 focus:bg-white focus:border-travel-primary focus:ring-2 focus:ring-travel-primary/20 outline-none transition text-sm">
                                <p class="text-xs text-red-400 mt-1" x-show="errors.departureDate"
                                    x-text="errors.departureDate"></p>
                            </div>
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-2">
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-4">
                                <button type="button" @click="form.participants = Math.max(1, form.participants - 1)"
                                ...
                                <span class="text-2xl font-bold text-gray-900 w-10 text-center"
                                    x-text="form.participants"></span>
                                <button type="button" @click="form.participants++"
                                    class="w-10 h-10 rounded-xl bg-gray-100 hover:bg-gray-200 flex items-center justify-center font-bold text-gray-600 transition cursor-pointer">
                                    +
                                </button>
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                                <template x-for="type in ['Keluarga', 'Pasangan', 'Rombongan', 'Solo']"
                                    :key="type">
                                    <button type="button" @click="form.tripType = type"
                        ...
                        <div>
                            <div class="flex justify-between items-end mb-4">
                                <label class="block text-sm font-semibold text-gray-700">
                                    ...
                                    <span class="text-gray-400 font-normal block mt-1 text-xs">(per orang)</span>
                                </label>
                                {{-- Teks Harga Real-time --}}
                                <div class="text-right">
                                    <span class="text-xl font-bold text-travel-primary"
                                        x-text="formatRupiah(form.budget)"></span>
                                    <span class="text-gray-400 font-normal text-sm">/per orang</span>
                                </div>
                            </div>

                            <div class="relative pt-1">
                                {{-- Input Slider --}}
                                <input type="range" x-model="form.budget" min="500000" max="10000000" step="100000"
                                    class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-travel-primary">
                        ...
                        <div>
                            ...
                            <div class="flex flex-wrap gap-2">
                                <template x-for="item in facilitiesOptions" :key="item">
                                    <button type="button" @click="toggleFacility(item)"
                ...
                <div x-show="currentStep === 4" x-transition:enter="transition ease-out duration-300"
                    ...
                    <div class="bg-zinc-50 rounded-2xl border border-gray-100 divide-y divide-gray-100 mb-6">
                        ...
                        <div class="flex justify-between items-start px-5 py-4">
                            ...
                            <span class="text-sm font-semibold text-gray-900 text-right"
                                x-text="formatDate(form.departureDate)"></span>
                        </div>
                        <div class="flex justify-between items-start px-5 py-4">
                        ...
                        <div class="flex justify-between items-start px-5 py-4">
                            ...
                            <span class="text-sm font-semibold text-gray-900 text-right"
                                x-text="form.participants + ' orang (' + form.tripType + ')'"></span>
                        </div>
                        <div class="flex justify-between items-start px-5 py-4">
                        ...
                        <div class="flex justify-between items-start px-5 py-4" x-show="form.facilities.length > 0">
                            ...
                            <span class="text-sm font-semibold text-gray-900 text-right"
                                x-text="form.facilities.join(', ')"></span>
                        </div>
                    ...
                    <p class="text-xs text-gray-400 text-center leading-relaxed">
                        Dengan menekan tombol di bawah, Anda akan diarahkan ke WhatsApp admin kami dengan detail permintaan
                        yang telah diisi.
                    </p>
                ...
                <div class="flex items-center justify-between mt-10 pt-6 border-t border-gray-100">
                    ...
                    {{-- Tombol Next / Kirim --}}
                    <button type="button" @click="currentStep < 4 ? nextStep() : sendToWhatsApp()"
                ...
                return {
                    ...
                    validateStep() {
                        ...
                        if (this.currentStep === 2) {
                            if (this.form.budget < 500000) this.errors.budget = 'Tentukan estimasi budget.';
                        }
...
*Anggaran*
- Budget   : ${this.formatRupiah(f.budget)} (per orang)
...
Apakah memungkinkan untuk dibuatkan paket dengan detail seperti di atas? Ditunggu informasi lebih lanjutnya ya. Terima kasih!`;
