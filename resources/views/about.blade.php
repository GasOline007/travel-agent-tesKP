        ...
        <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-12">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                @php
                    $teams = [
                        [
                            ...
                            'foto' => 'img/Picture1.png',
                        ],
                        [
                            'nama' => 'Rakha',
                            'posisi' => 'Media Creator',
                            'foto' => 'img/Picture2.png',
                        ],
                        [
                            'nama' => 'Ani',
                            'posisi' => 'Finance Manager',
                            'foto' => 'img/Picture3.png',
                        ],
                        [
                            'nama' => 'Rika',
                            'posisi' => 'Official',
                            'foto' => 'img/Picture4.png',
                        ],
                        [
                            'nama' => 'Raisa',
                            'posisi' => 'Official',
                            'foto' => 'img/Picture5.png',
                        ],
                        [
                            'nama' => 'Handaru',
                            'posisi' => 'Media Creator',
                            'foto' => 'img/Picture6.png',
                        ],
                    ];
                @endphp
                ...
                @foreach ($teams as $member)
                    <div
                        class="group relative overflow-hidden rounded-3xl bg-gray-900 border border-gray-800 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-travel-primary/10 p-8 flex flex-col items-center text-center">

                        {{-- Foto Profile Bulat (w-40 h-40 & rounded-full) --}}
                        <div
                            class="w-36 h-36 md:w-40 md:h-40 mb-6 rounded-full overflow-hidden bg-gray-800 border-4 border-gray-800 group-hover:border-travel-primary transition-colors duration-500 relative z-10 shrink-0">
                        ...
                        <div class="relative z-10">
                            <h4 class="text-xl font-bold text-white mb-2">{{ $member['nama'] }}</h4>
                        ...
                        <div
                            class="absolute top-0 left-0 w-full h-1.5 bg-travel-tertiary transform -translate-x-full group-hover:translate-x-0 transition-transform duration-500 z-20">
                        </div>

                        {{-- Aksen Cahaya Tipis di Belakang Foto --}}
                        <div
                            class="absolute top-12 left-1/2 -translate-x-1/2 w-32 h-32 bg-travel-primary/20 rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-0">
                        </div>
                    </div>
                @endforeach
    ...
    <main class="max-w-7xl mx-auto px-4 md:px-6 lg:px-12 -mt-10 md:-mt-20 relative z-10 mb-24">
        ...
        <div
            ...
            <div class="lg:w-1/2">
                ...
                <div class="space-y-4 text-gray-600 leading-relaxed text-lg">
                    <p>
                        ARFAKA merupakan suatu perusahaan yang bergerak dalam
                        ...
                        Kami juga mensupport rekanan dari Hotel, Agen Travel, Event
                        Organizer dan Lembaga Consulting Nasional.
                    </p>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
            <div
                ...
                <h3 class="text-xl font-bold text-white mb-3">Personal</h3>
                <p class="text-gray-400">Memberikan yang terbaik dengan, Attitude, Ramah,
            ...
            <div
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-3">Price</h3>
                <p class="text-gray-500">Memberikan solusi paket wisata dengan menyesuaikan
            ...
            <div
                ...
                <h3 class="text-xl font-bold text-white mb-3">Program</h3>
                <p class="text-gray-400">Pilihan paket wisata sesuai dengan keinginan anda dan
