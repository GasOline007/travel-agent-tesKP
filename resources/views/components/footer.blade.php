<footer class="bg-gray-950 pt-16 pb-8 text-gray-400 font-sans border-t border-gray-900">
    <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12 mb-16">
            ...
            <div class="lg:col-span-1">
                <a href="/" class="flex items-center space-x-2 mb-6">
                    ...
                    <span class="text-2xl font-bold tracking-tight text-white">Nravel</span>
                </a>
                <p class="text-sm leading-relaxed mb-6">
                    Menjelajahi keindahan alam liar Indonesia menjadi lebih mudah dan berkesan. Kami menyediakan paket perjalanan eksklusif dengan pelayanan terbaik untuk Anda.
                </p>
            ...
            <div>
                ...
                <ul class="space-y-4 text-sm">
                    ...
                    <li><a href="/travel-tips" class="hover:text-white transition-colors duration-300">Travel Tips & Panduan</a></li>
            ...
            <div>
                ...
                <ul class="space-y-4 text-sm">
                    <li><a href="/about" class="hover:text-white transition-colors duration-300">Tentang Nravel</a></li>
            ...
            <div>
                ...
                <ul class="space-y-4 text-sm">
                    ...
                    <li class="flex items-center">
                        ...
                        <a href="mailto:hello@nravel.com" class="hover:text-white transition-colors duration-300">hello@nravel.com</a>
                    </li>
                    <li class="flex items-center">
                        <svg class="w-5 h-5 mr-3 text-gray-500 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center text-sm">
            <p>&copy; {{ date('Y') }} Nravel. All rights reserved.</p>
