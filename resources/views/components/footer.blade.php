<footer class="bg-gray-950 pt-16 pb-8 text-gray-400 font-sans border-t border-gray-900">
    <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12 mb-16">
            ...
            <div class="lg:col-span-1">
                ...
                {{-- 1. Panggil deskripsi/about text --}}
                <p class="text-sm leading-relaxed mb-6">
                    {{ $company->about_text ?? 'Menjelajahi keindahan alam liar Indonesia menjadi lebih mudah dan berkesan. Kami menyediakan paket perjalanan eksklusif dengan pelayanan terbaik untuk Anda.' }}
                </p>
                <div class="flex space-x-4">
                    {{-- 2. Panggil Link Instagram (Gunakan ?? '#' sebagai cadangan jika kosong) --}}
                    <a href="{{ $company->instagram_url ?? '#' }}" target="_blank" class="text-gray-400 hover:text-white transition-colors duration-300">
                    ...
                    {{-- 3. Panggil Link Facebook --}}
                    <a href="{{ $company->facebook_url ?? '#' }}" target="_blank" class="text-gray-400 hover:text-white transition-colors duration-300">
            ...
            <div>
                ...
                <ul class="space-y-4 text-sm">
                    <li class="flex items-start">
                        ...
                        {{-- Alamat --}}
                        <span>{{ $company->address ?? 'Alamat Belum Diinputkan' }}</span>
                    </li>
                    <li class="flex items-center">
                        ...
                        {{-- Email --}}
                        <a href="mailto:{{ $company->email ?? 'arfaka@gmail.com' }}" class="hover:text-white transition-colors duration-300">
                            {{ $company->email ?? 'arfaka@gmail.com' }}
                        </a>
                    </li>
                    <li class="flex items-center">
                        <svg class="w-5 h-5 mr-3 text-gray-500 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
