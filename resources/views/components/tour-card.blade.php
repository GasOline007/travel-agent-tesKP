...
<div data-aos="fade-up"
    ...
    <div class="relative overflow-hidden">
        ...
        @if (isset($paket['is_recommended']) && $paket['is_recommended'])
            <div
                class="absolute -top-2 -left-16 bg-lime-400 w-48 h-20 text-gray-900 shadow-lg flex items-center justify-center z-10 -rotate-45">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="size-10 rotate-45 group-hover:animate-bounce">
